...
import { IgrejaComponent } from 'app/entities/igreja/igreja.component';
import { IgrejaService } from 'app/entities/igreja/igreja.service';
import { Igreja } from 'app/shared/model/igreja.model';

describe('Component Tests', () => {
  describe('Igreja Management Component', () => {
    let comp: IgrejaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IgrejaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.igrejas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
