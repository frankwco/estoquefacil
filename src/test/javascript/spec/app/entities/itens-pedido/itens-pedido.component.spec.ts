...
import { ItensPedidoComponent } from 'app/entities/itens-pedido/itens-pedido.component';
...
describe('Component Tests', () => {
  describe('ItensPedido Management Component', () => {
    let comp: ItensPedidoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ItensPedidoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itensPedidos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
